...
const static uint8_t e_permtab[] = {
...
const static uint8_t p_permtab[] = {
	 4,  4,						/* 32 bit -> 32 bit */
	16,  7, 20, 21,
	29, 12, 28, 17,
	 1, 15, 23, 26,
...
const static uint8_t ip_permtab[] = {
	 8,  8,						/* 64 bit -> 64 bit */
...
const static uint8_t inv_ip_permtab[] = {
	 8, 8,						/* 64 bit -> 64 bit */
...
const static uint8_t pc1_permtab[] = {
	 8,  7, 					/* 64 bit -> 56 bit*/
	57, 49, 41, 33, 25, 17,  9,
	 1, 58, 50, 42, 34, 26, 18,
	10,  2, 59, 51, 43, 35, 27,
...
const static uint8_t pc2_permtab[] = {
	 7,	 6, 					/* 56 bit -> 48 bit */
	14, 17, 11, 24,  1,  5,
	 3, 28, 15,  6, 21, 10,
	23, 19, 12,  4, 26,  8,
...
const static uint8_t splitin6bitword_permtab[] = {
	 8,  8, 					/* 64 bit -> 64 bit */
	64, 64,  1,  6,  2,  3,  4,  5, 
...
const static uint8_t shiftkey_permtab[] = {
	 7,  7, 					/* 56 bit -> 56 bit */
	 2,  3,  4,  5,  6,  7,  8,  9,
...
const static uint8_t shiftkeyinv_permtab[] = {
	 7,  7,
	28,  1,  2,  3,  4,  5,  6,  7,
...
extern void des_dec(void *out, const void *in, const uint8_t *key){
	uint8_t kr[6],k[7];
	union {
		uint8_t v8[8];
		uint32_t v32[2];
...
extern void tdes_enc(void *out, void *in, const void *key){
...
extern void tdes_dec(void *out, void *in, const uint8_t *key){
